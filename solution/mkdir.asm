 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 98 08 00 00 	movzbl 0x898(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 40 08 00 00 	jmp    *0x840(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 37 08 00 00       	mov    $0x837,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 e8 0b 00 00       	mov    0xbe8,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d e8 0b 00 00    	mov    0xbe8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d e8 0b 00 00    	mov    0xbe8,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 e8 0b 00 00    	mov    0xbe8,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
}
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 e8 0b 00 00 ec 	movl   $0xbec,0xbe8
 747:	0b 00 00 
    base.s.size = 0;
 74a:	bf ec 0b 00 00       	mov    $0xbec,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 ec 0b 00 00 ec 	movl   $0xbec,0xbec
 756:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 f0 0b 00 00 00 	movl   $0x0,0xbf0
 762:	00 00 00 
    if(p->s.size >= nunits){
...
vmalloc(uint n, int flag)
{
 ...
 7b6:	e8 a0 fb ff ff       	call   35b <sbrk>
 ...
 7c4:	0f 44 c2             	cmove  %edx,%eax
}
 7c7:	c3                   	ret    
        printf(1, "Error flag init (vmalloc)\n");
 7c8:	50                   	push   %eax
 7c9:	50                   	push   %eax
 7ca:	68 a9 08 00 00       	push   $0x8a9
 7cf:	6a 01                	push   $0x1
 7d1:	e8 7a fc ff ff       	call   450 <printf>
        exit();
 7d6:	e8 f8 fa ff ff       	call   2d3 <exit>
...
vfree(void *ptr)
{
 ...
 7ef:	50                   	push   %eax
 7f0:	50                   	push   %eax
 7f1:	68 c4 08 00 00       	push   $0x8c4
 7f6:	6a 01                	push   $0x1
 7f8:	e8 53 fc ff ff       	call   450 <printf>
        exit();
 7fd:	e8 d1 fa ff ff       	call   2d3 <exit>
