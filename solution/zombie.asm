 ...
 35c:	89 d1                	mov    %edx,%ecx
{
 ...
 389:	0f b6 92 14 08 00 00 	movzbl 0x814(%edx),%edx
 ...
 409:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 479:	ff 24 85 bc 07 00 00 	jmp    *0x7bc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 587:	90                   	nop
          s = "(null)";
 588:	ba b4 07 00 00       	mov    $0x7b4,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5a1:	a1 54 0b 00 00       	mov    0xb54,%eax
{
 ...
 5e1:	5b                   	pop    %ebx
  freep = p;
 5e2:	89 15 54 0b 00 00    	mov    %edx,0xb54
}
 5e8:	5e                   	pop    %esi
 5e9:	5f                   	pop    %edi
 5ea:	5d                   	pop    %ebp
 ...
 619:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61c:	89 15 54 0b 00 00    	mov    %edx,0xb54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 4f                	jae    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
 ...
 6aa:	e8 f1 fe ff ff       	call   5a0 <free>
  return freep;
 6af:	8b 15 54 0b 00 00    	mov    0xb54,%edx
 ...
 6dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6df:	89 15 54 0b 00 00    	mov    %edx,0xb54
}
 ...
 6ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 54 0b 00 00 58 	movl   $0xb58,0xb54
 6f7:	0b 00 00 
    base.s.size = 0;
 6fa:	bf 58 0b 00 00       	mov    $0xb58,%edi
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 58 0b 00 00 58 	movl   $0xb58,0xb58
 706:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 709:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 70b:	c7 05 5c 0b 00 00 00 	movl   $0x0,0xb5c
 712:	00 00 00 
    if(p->s.size >= nunits){
...
vmalloc(uint n, int flag)
{
 ...
 766:	e8 a0 fb ff ff       	call   30b <sbrk>
 76b:	83 c4 10             	add    $0x10,%esp
        return 0;
 76e:	31 d2                	xor    %edx,%edx
}
 770:	c9                   	leave  
        return 0;
 771:	83 f8 ff             	cmp    $0xffffffff,%eax
 774:	0f 44 c2             	cmove  %edx,%eax
}
 777:	c3                   	ret    
        printf(1, "Error flag init (vmalloc)\n");
 778:	50                   	push   %eax
 779:	50                   	push   %eax
 77a:	68 25 08 00 00       	push   $0x825
 77f:	6a 01                	push   $0x1
 781:	e8 7a fc ff ff       	call   400 <printf>
        exit();
 786:	e8 f8 fa ff ff       	call   283 <exit>
...
vfree(void *ptr)
{
 ...
 79f:	50                   	push   %eax
 7a0:	50                   	push   %eax
 7a1:	68 40 08 00 00       	push   $0x840
 7a6:	6a 01                	push   $0x1
 7a8:	e8 53 fc ff ff       	call   400 <printf>
        exit();
 7ad:	e8 d1 fa ff ff       	call   283 <exit>
