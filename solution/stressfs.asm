 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 48 09 00 00 	movzbl 0x948(%edx),%edx
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 589:	ff 24 85 f0 08 00 00 	jmp    *0x8f0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 697:	90                   	nop
          s = "(null)";
 698:	ba e7 08 00 00       	mov    $0x8e7,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 98 0c 00 00       	mov    0xc98,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 98 0c 00 00    	mov    %edx,0xc98
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 98 0c 00 00    	mov    %edx,0xc98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d 98 0c 00 00    	mov    0xc98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d 98 0c 00 00    	mov    0xc98,%edi
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 98 0c 00 00    	mov    0xc98,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 98 0c 00 00    	mov    %edx,0xc98
}
 ...
 7ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 98 0c 00 00 9c 	movl   $0xc9c,0xc98
 807:	0c 00 00 
    base.s.size = 0;
 80a:	bf 9c 0c 00 00       	mov    $0xc9c,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 9c 0c 00 00 9c 	movl   $0xc9c,0xc9c
 816:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 a0 0c 00 00 00 	movl   $0x0,0xca0
 822:	00 00 00 
    if(p->s.size >= nunits){
...
vmalloc(uint n, int flag)
{
 ...
 876:	e8 a0 fb ff ff       	call   41b <sbrk>
 87b:	83 c4 10             	add    $0x10,%esp
        return 0;
 87e:	31 d2                	xor    %edx,%edx
}
 880:	c9                   	leave  
        return 0;
 881:	83 f8 ff             	cmp    $0xffffffff,%eax
 884:	0f 44 c2             	cmove  %edx,%eax
}
 887:	c3                   	ret    
        printf(1, "Error flag init (vmalloc)\n");
 888:	50                   	push   %eax
 889:	50                   	push   %eax
 88a:	68 59 09 00 00       	push   $0x959
 88f:	6a 01                	push   $0x1
 891:	e8 7a fc ff ff       	call   510 <printf>
        exit();
 896:	e8 f8 fa ff ff       	call   393 <exit>
...
vfree(void *ptr)
{
 ...
 8af:	50                   	push   %eax
 8b0:	50                   	push   %eax
 8b1:	68 74 09 00 00       	push   $0x974
 8b6:	6a 01                	push   $0x1
 8b8:	e8 53 fc ff ff       	call   510 <printf>
        exit();
 8bd:	e8 d1 fa ff ff       	call   393 <exit>
