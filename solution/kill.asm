 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba f8 07 00 00       	mov    $0x7f8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 a8 0b 00 00       	mov    0xba8,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 a8 0b 00 00    	mov    %edx,0xba8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d a8 0b 00 00    	mov    0xba8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d a8 0b 00 00    	mov    0xba8,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 a8 0b 00 00    	mov    0xba8,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 a8 0b 00 00 ac 	movl   $0xbac,0xba8
 727:	0b 00 00 
    base.s.size = 0;
 72a:	bf ac 0b 00 00       	mov    $0xbac,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 ac 0b 00 00 ac 	movl   $0xbac,0xbac
 736:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 b0 0b 00 00 00 	movl   $0x0,0xbb0
 742:	00 00 00 
    if(p->s.size >= nunits){
...
vmalloc(uint n, int flag)
{
 ...
 796:	e8 a0 fb ff ff       	call   33b <sbrk>
 ...
 7a4:	0f 44 c2             	cmove  %edx,%eax
}
 7a7:	c3                   	ret    
        printf(1, "Error flag init (vmalloc)\n");
 7a8:	50                   	push   %eax
 7a9:	50                   	push   %eax
 7aa:	68 69 08 00 00       	push   $0x869
 7af:	6a 01                	push   $0x1
 7b1:	e8 7a fc ff ff       	call   430 <printf>
        exit();
 7b6:	e8 f8 fa ff ff       	call   2b3 <exit>
...
vfree(void *ptr)
{
 ...
 7cf:	50                   	push   %eax
 7d0:	50                   	push   %eax
 7d1:	68 84 08 00 00       	push   $0x884
 7d6:	6a 01                	push   $0x1
 7d8:	e8 53 fc ff ff       	call   430 <printf>
        exit();
 7dd:	e8 d1 fa ff ff       	call   2b3 <exit>
