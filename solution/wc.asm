 ...
 4ac:	89 d1                	mov    %edx,%ecx
{
 ...
 4d9:	0f b6 92 9c 09 00 00 	movzbl 0x99c(%edx),%edx
 ...
 559:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c9:	ff 24 85 44 09 00 00 	jmp    *0x944(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6d7:	90                   	nop
          s = "(null)";
 6d8:	ba 3b 09 00 00       	mov    $0x93b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f1:	a1 20 0f 00 00       	mov    0xf20,%eax
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	89 15 20 0f 00 00    	mov    %edx,0xf20
}
 738:	5e                   	pop    %esi
 739:	5f                   	pop    %edi
 73a:	5d                   	pop    %ebp
 ...
 769:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 76c:	89 15 20 0f 00 00    	mov    %edx,0xf20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 3d 20 0f 00 00    	mov    0xf20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 4f                	jae    820 <malloc+0xa0>
    ...
    if(p == freep)
 7d1:	8b 3d 20 0f 00 00    	mov    0xf20,%edi
 ...
 7fa:	e8 f1 fe ff ff       	call   6f0 <free>
  return freep;
 7ff:	8b 15 20 0f 00 00    	mov    0xf20,%edx
 ...
 82c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 82f:	89 15 20 0f 00 00    	mov    %edx,0xf20
}
 ...
 83f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 20 0f 00 00 24 	movl   $0xf24,0xf20
 847:	0f 00 00 
    base.s.size = 0;
 84a:	bf 24 0f 00 00       	mov    $0xf24,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 24 0f 00 00 24 	movl   $0xf24,0xf24
 856:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 85b:	c7 05 28 0f 00 00 00 	movl   $0x0,0xf28
 862:	00 00 00 
    if(p->s.size >= nunits){
...
vmalloc(uint n, int flag)
{
 ...
 8b6:	e8 a0 fb ff ff       	call   45b <sbrk>
 8bb:	83 c4 10             	add    $0x10,%esp
        return 0;
 8be:	31 d2                	xor    %edx,%edx
}
 8c0:	c9                   	leave  
        return 0;
 8c1:	83 f8 ff             	cmp    $0xffffffff,%eax
 8c4:	0f 44 c2             	cmove  %edx,%eax
}
 8c7:	c3                   	ret    
        printf(1, "Error flag init (vmalloc)\n");
 8c8:	50                   	push   %eax
 8c9:	50                   	push   %eax
 8ca:	68 ad 09 00 00       	push   $0x9ad
 8cf:	6a 01                	push   $0x1
 8d1:	e8 7a fc ff ff       	call   550 <printf>
        exit();
 8d6:	e8 f8 fa ff ff       	call   3d3 <exit>
...
vfree(void *ptr)
{
 ...
 8e9:	85 d2                	test   %edx,%edx
 8eb:	78 02                	js     8ef <vfree+0xf>
 ...
 8ef:	50                   	push   %eax
 8f0:	50                   	push   %eax
 8f1:	68 c8 09 00 00       	push   $0x9c8
 8f6:	6a 01                	push   $0x1
 8f8:	e8 53 fc ff ff       	call   550 <printf>
        exit();
 8fd:	e8 d1 fa ff ff       	call   3d3 <exit>
