...
fork1(void)
{
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     106:	68 fd 13 00 00       	push   $0x13fd
     10b:	6a 02                	push   $0x2
  ...
  exit();
    ...
    panic("fork");
     ...
     122:	68 57 13 00 00       	push   $0x1357
...
00000130 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     13e:	68 54 13 00 00       	push   $0x1354
     143:	6a 02                	push   $0x2
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 f1 13 00 00       	push   $0x13f1
     17e:	6a 02                	push   $0x2
...
00000190 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 57 13 00 00       	push   $0x1357
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 0c 14 00 00 	jmp    *0x140c(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1e9:	68 63 13 00 00       	push   $0x1363
     1ee:	6a 02                	push   $0x2
    ...
    panic("runcmd");
     ...
     2cf:	68 83 13 00 00       	push   $0x1383
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 10 1b 00 00       	push   $0x1b10
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 10 1b 00 00       	push   $0x1b10
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 08 1b 00 00       	push   $0x1b08
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 10 1b 00 00       	push   $0x1b10
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 10 1b 00 00       	push   $0x1b10
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 a5 13 00 00       	push   $0x13a5
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  return cmd;
     ...
     77e:	68 88 13 00 00       	push   $0x1388
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 a8 13 00 00       	push   $0x13a8
     7a4:	57                   	push   %edi
     7a5:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 bf 13 00 00       	push   $0x13bf
     80b:	57                   	push   %edi
     80c:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 b1 13 00 00       	push   $0x13b1
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 aa 13 00 00       	push   $0x13aa
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 c4 13 00 00       	push   $0x13c4
  cmd = parseexec(ps, es);
...
00000940 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 c6 13 00 00       	push   $0x13c6
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 c2 13 00 00       	push   $0x13c2
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 a8 13 00 00       	push   $0x13a8
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 e4 13 00 00       	push   $0x13e4
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ac9:	ff 24 85 24 14 00 00 	jmp    *0x1424(,%eax,4)
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 c7 14 00 00       	push   $0x14c7
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     bae:	52                   	push   %edx
     baf:	50                   	push   %eax
     bb0:	68 e6 13 00 00       	push   $0x13e6
     bb5:	6a 02                	push   $0x2
     bb7:	e8 e4 03 00 00       	call   fa0 <printf>
    panic("syntax");
     bbc:	c7 04 24 aa 13 00 00 	movl   $0x13aa,(%esp)
     ...
     efc:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f29:	0f b6 92 9c 14 00 00 	movzbl 0x149c(%edx),%edx
     ...
     fa9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1019:	ff 24 85 44 14 00 00 	jmp    *0x1444(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1127:	90                   	nop
          s = "(null)";
    1128:	ba 3c 14 00 00       	mov    $0x143c,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1141:	a1 84 1b 00 00       	mov    0x1b84,%eax
{
  ...
  freep = p;
    ...
    1181:	5b                   	pop    %ebx
  freep = p;
    1182:	89 15 84 1b 00 00    	mov    %edx,0x1b84
}
    1188:	5e                   	pop    %esi
    1189:	5f                   	pop    %edi
    118a:	5d                   	pop    %ebp
  ...
  freep = p;
    11bc:	89 15 84 1b 00 00    	mov    %edx,0x1b84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11dc:	8b 3d 84 1b 00 00    	mov    0x1b84,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1221:	8b 3d 84 1b 00 00    	mov    0x1b84,%edi
  ...
  return freep;
    124f:	8b 15 84 1b 00 00    	mov    0x1b84,%edx
    ...
    127c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    127f:	89 15 84 1b 00 00    	mov    %edx,0x1b84
}
    ...
    128f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1290:	c7 05 84 1b 00 00 88 	movl   $0x1b88,0x1b84
    1297:	1b 00 00 
    base.s.size = 0;
    129a:	bf 88 1b 00 00       	mov    $0x1b88,%edi
    base.s.ptr = freep = prevp = &base;
    129f:	c7 05 88 1b 00 00 88 	movl   $0x1b88,0x1b88
    12a6:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    12ab:	c7 05 8c 1b 00 00 00 	movl   $0x0,0x1b8c
    12b2:	00 00 00 
    if(p->s.size >= nunits){
...
vmalloc(uint n, int flag)
{
    ...
    12dc:	77 3a                	ja     1318 <vmalloc+0x48>
        printf(1, "Error flag init (vmalloc)\n");
        exit();
    }
    if(flag == VMALLOC_SIZE_BASE)
    12de:	85 c0                	test   %eax,%eax
    12e0:	74 1e                	je     1300 <vmalloc+0x30>
        ptr = sbrk(n);
    else
        ptr = sbrkhuge(n);
    12e2:	83 ec 0c             	sub    $0xc,%esp
    12e5:	ff 75 08             	push   0x8(%ebp)
    12e8:	e8 f6 fb ff ff       	call   ee3 <sbrkhuge>
    ...
    12f6:	0f 44 c2             	cmove  %edx,%eax
}
    12f9:	c3                   	ret    
    12fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        ptr = sbrk(n);
    1300:	83 ec 0c             	sub    $0xc,%esp
    1303:	ff 75 08             	push   0x8(%ebp)
    1306:	e8 a0 fb ff ff       	call   eab <sbrk>
    130b:	83 c4 10             	add    $0x10,%esp
        return 0;
    130e:	31 d2                	xor    %edx,%edx
}
    1310:	c9                   	leave  
        return 0;
    1311:	83 f8 ff             	cmp    $0xffffffff,%eax
    1314:	0f 44 c2             	cmove  %edx,%eax
}
    1317:	c3                   	ret    
        printf(1, "Error flag init (vmalloc)\n");
    1318:	50                   	push   %eax
    1319:	50                   	push   %eax
    131a:	68 ad 14 00 00       	push   $0x14ad
    131f:	6a 01                	push   $0x1
    1321:	e8 7a fc ff ff       	call   fa0 <printf>
        exit();
    1326:	e8 f8 fa ff ff       	call   e23 <exit>
...
vfree(void *ptr)
{
    ...
    133f:	50                   	push   %eax
    1340:	50                   	push   %eax
    1341:	68 c8 14 00 00       	push   $0x14c8
    1346:	6a 01                	push   $0x1
    1348:	e8 53 fc ff ff       	call   fa0 <printf>
        exit();
    134d:	e8 d1 fa ff ff       	call   e23 <exit>
