 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba cc 08 00 00       	mov    $0x8cc,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 c0 0e 00 00       	mov    0xec0,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 c0 0e 00 00    	mov    %edx,0xec0
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 c0 0e 00 00    	mov    %edx,0xec0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d c0 0e 00 00    	mov    0xec0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d c0 0e 00 00    	mov    0xec0,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 c0 0e 00 00    	mov    0xec0,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 c0 0e 00 00    	mov    %edx,0xec0
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 c0 0e 00 00 c4 	movl   $0xec4,0xec0
 7d7:	0e 00 00 
    base.s.size = 0;
 7da:	bf c4 0e 00 00       	mov    $0xec4,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 c4 0e 00 00 c4 	movl   $0xec4,0xec4
 7e6:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 c8 0e 00 00 00 	movl   $0x0,0xec8
 7f2:	00 00 00 
    if(p->s.size >= nunits){
...
vmalloc(uint n, int flag)
{
 ...
 836:	0f 44 c2             	cmove  %edx,%eax
}
 839:	c3                   	ret    
 83a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        ptr = sbrk(n);
 840:	83 ec 0c             	sub    $0xc,%esp
 843:	ff 75 08             	push   0x8(%ebp)
 846:	e8 a0 fb ff ff       	call   3eb <sbrk>
 84b:	83 c4 10             	add    $0x10,%esp
        return 0;
 84e:	31 d2                	xor    %edx,%edx
}
 850:	c9                   	leave  
        return 0;
 851:	83 f8 ff             	cmp    $0xffffffff,%eax
 854:	0f 44 c2             	cmove  %edx,%eax
}
 857:	c3                   	ret    
        printf(1, "Error flag init (vmalloc)\n");
 858:	50                   	push   %eax
 859:	50                   	push   %eax
 85a:	68 3d 09 00 00       	push   $0x93d
 85f:	6a 01                	push   $0x1
 861:	e8 7a fc ff ff       	call   4e0 <printf>
        exit();
 866:	e8 f8 fa ff ff       	call   363 <exit>
...
vfree(void *ptr)
{
 ...
 87f:	50                   	push   %eax
 880:	50                   	push   %eax
 881:	68 58 09 00 00       	push   $0x958
 886:	6a 01                	push   $0x1
 888:	e8 53 fc ff ff       	call   4e0 <printf>
        exit();
 88d:	e8 d1 fa ff ff       	call   363 <exit>
