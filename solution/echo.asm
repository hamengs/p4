...
main(int argc, char *argv[])
{
  ...
  2e:	66 90                	xchg   %ax,%ax
  30:	68 f4 07 00 00       	push   $0x7f4
  35:	83 c3 01             	add    $0x1,%ebx
  38:	50                   	push   %eax
  39:	68 f6 07 00 00       	push   $0x7f6
  3e:	6a 01                	push   $0x1
  ...
  50:	68 86 08 00 00       	push   $0x886
  55:	50                   	push   %eax
  56:	68 f6 07 00 00       	push   $0x7f6
  5b:	6a 01                	push   $0x1
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba fb 07 00 00       	mov    $0x7fb,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 a8 0b 00 00       	mov    0xba8,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 a8 0b 00 00    	mov    %edx,0xba8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d a8 0b 00 00    	mov    0xba8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d a8 0b 00 00    	mov    0xba8,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 a8 0b 00 00    	mov    0xba8,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 a8 0b 00 00 ac 	movl   $0xbac,0xba8
 737:	0b 00 00 
    base.s.size = 0;
 73a:	bf ac 0b 00 00       	mov    $0xbac,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 ac 0b 00 00 ac 	movl   $0xbac,0xbac
 746:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 b0 0b 00 00 00 	movl   $0x0,0xbb0
 752:	00 00 00 
    if(p->s.size >= nunits){
...
vmalloc(uint n, int flag)
{
 ...
 77c:	77 3a                	ja     7b8 <vmalloc+0x48>
        printf(1, "Error flag init (vmalloc)\n");
        exit();
    }
    if(flag == VMALLOC_SIZE_BASE)
 77e:	85 c0                	test   %eax,%eax
 780:	74 1e                	je     7a0 <vmalloc+0x30>
        ptr = sbrk(n);
    else
        ptr = sbrkhuge(n);
 782:	83 ec 0c             	sub    $0xc,%esp
 785:	ff 75 08             	push   0x8(%ebp)
 788:	e8 f6 fb ff ff       	call   383 <sbrkhuge>
 ...
 7a6:	e8 a0 fb ff ff       	call   34b <sbrk>
 7ab:	83 c4 10             	add    $0x10,%esp
        return 0;
 7ae:	31 d2                	xor    %edx,%edx
}
 7b0:	c9                   	leave  
        return 0;
 7b1:	83 f8 ff             	cmp    $0xffffffff,%eax
 7b4:	0f 44 c2             	cmove  %edx,%eax
}
 7b7:	c3                   	ret    
        printf(1, "Error flag init (vmalloc)\n");
 7b8:	50                   	push   %eax
 7b9:	50                   	push   %eax
 7ba:	68 6d 08 00 00       	push   $0x86d
 7bf:	6a 01                	push   $0x1
 7c1:	e8 7a fc ff ff       	call   440 <printf>
        exit();
 7c6:	e8 f8 fa ff ff       	call   2c3 <exit>
...
vfree(void *ptr)
{
 ...
 7df:	50                   	push   %eax
 7e0:	50                   	push   %eax
 7e1:	68 88 08 00 00       	push   $0x888
 7e6:	6a 01                	push   $0x1
 7e8:	e8 53 fc ff ff       	call   440 <printf>
        exit();
 7ed:	e8 d1 fa ff ff       	call   2c3 <exit>
